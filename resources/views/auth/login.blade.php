...
<head>
  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" id="fLogin" action="{{URL::to('auth/login')}}" method="POST">
        <h2 class="form-signin-heading">sign in now</h2>
        <div class="login-wrap">
            <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
            <input type="text" class="form-control" name="email" placeholder="User Email" autofocus>
            <input type="password" class="form-control" tabindex="2" name="password" placeholder="Password">
