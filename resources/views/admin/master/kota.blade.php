...
<header class="panel-heading">
    {{Lang::get('admin.city_grid')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.city_grid')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/kota/grid'); ?>"
        ...
        <thead>
            <tr>
                <th data-options="field:'area_code',width:150">{{Lang::get('admin.code_area')}}</th>
                <th data-options="field:'propinsi',width:350">{{Lang::get('admin.propinsi')}}</th>                
