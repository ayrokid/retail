...
<header class="panel-heading">
    {{Lang::get('admin.propinsi')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.propinsi')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/propinsi/grid'); ?>"
        ...
        <thead>
            <tr>
                ...
                <th data-options="field:'negara',width:350">{{Lang::get('admin.negara')}}</th>                
