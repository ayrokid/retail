...
<header class="panel-heading">
    {{Lang::get('admin.kelompok')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.kelompok')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/kelompok/grid'); ?>"
        ...
        <thead>
            <tr>
                <th data-options="field:'update',width:500,align:'right'">{{Lang::get('admin.last_update')}}</th>
      ...
      <div id="tb">
          ...
          <a class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal' href="{{ url('master/kelompok/new') }}" >
