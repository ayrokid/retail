...
<header class="panel-heading">
    {{Lang::get('admin.negara')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.negara')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/negara/grid'); ?>"
      ...
      <div id="tb">
          ...
          <a class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal' href="{{ url('master/negara/new') }}" >
