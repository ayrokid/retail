...
<header class="panel-heading">
    {{Lang::get('admin.kecamatan')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.kecamatan')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/kecamatan/grid'); ?>"
        ...
        <thead>
            <tr>
                ...
                <th data-options="field:'kota',width:350">{{Lang::get('admin.kota')}}</th>                
