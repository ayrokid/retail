...
<header class="panel-heading">
    {{Lang::get('admin.grade')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.grade')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/grade/grid'); ?>"
        data-options="singleSelect:true,method:'get',toolbar:'#tb'">
        <thead data-options="frozen:true">
            <tr>
                <th data-options="field:'name',width:300">{{Lang::get('admin.name')}}</th>
            </tr>
        </thead>    
        <thead>
            <tr>
                <th data-options="field:'discount',width:150,align:'right'">{{Lang::get('admin.discount')}}</th>                
      ...
      <div id="tb">
          ...
          <a class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal' href="{{ url('master/grade/new') }}" >
