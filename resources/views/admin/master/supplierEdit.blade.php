<div class="modal-header">
    ...
    <h4 class="modal-title">{{ Lang::get('admin.edit_supplier') }}</h4>
</div>
<div class="modal-body">
  <form id="nForm" role="form" action="" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control placeholder-no-fix" id="fax" value="{{$data->fax}}" placeholder="" autocomplete="off" />
      </div>
      <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('.save').click(function(event) {
      ...
      $.post('{{url("master/supplier/save/$data->id")}}', post, function(data, textStatus, xhr) {
        if(data.back == 'true'){
          $('#myModal').modal('hide');
