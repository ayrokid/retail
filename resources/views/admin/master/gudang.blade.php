...
<header class="panel-heading">
    {{Lang::get('admin.warehouse')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="{{Lang::get('admin.warehouse')}}" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/gudang/grid'); ?>"
        ...
        <thead>
            <tr>
                <th data-options="field:'address',width:150">{{Lang::get('admin.address')}}</th>
                <th data-options="field:'telepon',width:150">{{Lang::get('admin.telepon')}}</th>
                <th data-options="field:'hp',width:150">{{Lang::get('admin.hp')}}</th>
                <th data-options="field:'kecamatan',width:150">{{Lang::get('admin.kecamatan')}}</th>                
      ...
      <div id="tb">
          ...
          <a class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal' href="{{ url('master/gudang/new') }}" >
