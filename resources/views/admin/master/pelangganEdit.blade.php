...
<div class="modal-body">
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10 col-sm-10">
          <input type="text" class="form-control placeholder-no-fix" name="name" id="name" placeholder="{{Lang::get('admin.pelanggan')}}" value="{{ $data->name }}" autocomplete="off" required />
      ...
      <div class="form-group">
        ...
        <div class="col-lg-10 col-sm-10">
          <input type="text" class="form-control placeholder-no-fix" name="address" id="address" placeholder="{{Lang::get('admin.address')}}" value="{{ $data->address }}" autocomplete="off" required />
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 col-sm-2 control-label" for="hp">{{ Lang::get('admin.hp') }}</label>
        <div class="col-lg-10 col-sm-10">
          <input type="text" class="form-control placeholder-no-fix numeric" name="hp" id="hp" placeholder="{{Lang::get('admin.hp')}}" value="{{ $data->hp }}" autocomplete="off" required />
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 col-sm-2 control-label" for="telepon">{{ Lang::get('admin.telepon') }}</label>
        <div class="col-lg-10 col-sm-10">
          <input type="text" class="form-control placeholder-no-fix numeric" name="telepon" placeholder="{{Lang::get('admin.telepon')}}" value="{{ $data->telepon }}" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 col-sm-2 control-label" for="email">{{ Lang::get('admin.e_mail') }}</label>
        <div class="col-lg-10 col-sm-10">
          <input type="email" class="form-control placeholder-no-fix numeric" name="email" placeholder="{{Lang::get('admin.e_mail')}}" value="{{ $data->email }}" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-lg-2 col-sm-2 control-label" for="fax">{{ Lang::get('admin.fax') }}</label>
        <div class="col-lg-10 col-sm-10">
          <input type="text" class="form-control placeholder-no-fix numeric" name="fax" placeholder="{{Lang::get('admin.fax')}}" value="{{ $data->fax }}" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        ...
        <select class="form-control" id="propinsi" required >
          ...
          <option  {{ ($val->id == $data->kota_id)? 'selected' : '' }} value="{{ $val->id }}">{{ $val->name }}</option>  
          @endforeach
        </select>
        </div>
      </div>
