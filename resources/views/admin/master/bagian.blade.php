...
<header class="panel-heading">
    {{Lang::get('admin.bagian_grid')}}
</header>
<div class="panel-body">
      <table class="easyui-datagrid" id="grid" title="Grid" style="width: auto;height:450px"
        rownumbers="true" pagination="true"
        url="<?php echo url('master/bagian/grid'); ?>"
      ...
      <div id="tb">
          ...
          <a class='btn btn-success btn-sm' data-toggle='modal' data-target='#myModal' href="{{ url('master/bagian/new') }}" >
