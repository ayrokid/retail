...
class NegaraController extends HomeController {
	...
	{
		return view('admin.master.negara');
	}
	...
	public function grid(Request $request)
	{
		...
		foreach ($getTable->skip($offset)->take($limit)->get() as $row) {
			$link['edit'] = array(
				'url' => url('master/negara/edit/'.$row->id)
			);
			$link['delete'] = array(
				'url' => url('master/negara/delete/'.$row->id),
				'back'=> url('master/negara')
			);
